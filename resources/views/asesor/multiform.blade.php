                        ...
                        <table class="table">
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td>
                                <h6>Konsistensi dengan hasil analisis SWOT dan/atau analisis lain serta rencana pengembangan ke depan</h6>
                                <ol style="list-style-type: none;">
                                  <b><li>Nilai 4</li></b>
                                  Unit Pengelola Program Studi (UPPS) mampu:
                                  <ol>
                        ...
                        <table class="table">
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td>
                                  <h6>Cara menghitung Skor ()Skor = (A + (2 x B)) / 3)</h6>
                                  <h6>A. Kelengkapan struktur 
                                    organisasi dan 
                                    keefektifan 
                                    penyelenggaraan 
                                    organisasi.</h6>
                          ...
                          <tr>
                            ...
                            <th scope="row"></th>
                            <td>
                                <h6>Cara menghitung Skor (Skor = ((2 x A) + B) / 3)</h6>
                                <h6>A. Kerjasama 
                                  pendidikan, penelitian,
                                  dan PkM yang relevan 
                                  dengan program studi 
                          ...
                          <tr>
                            ...
                            <th scope="row">C.2.5 
                              ...
                              Tambahan</th>
                            <td>
                                <h6 class="modal-title fs-5" id="modalc10">Pelampauan SN-DIKTI 
                                  yang ditetapkan dengan 
                                  indikator kinerja 
                                  tambahan yang berlaku 
                                  di UPPS berdasarkan 
                        ...
                        <table class="table">
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td>
                                  <h6>Metoda rekrutmen dan 
                                    keketatan seleksi.
                                    <br><br>
                                    Tabel 2.a LKPS</h6>
                                  <h6>Untuk program studi dengan jumlah kebutuhan lulusan tinggi berlaku perhitungan sebagai berikut.
                                  </h6>
                                    <ol style="list-style-type: none;">
                                      <b><li>Nilai 4</li></b>
                                      Jika Rasio >= 5 , 
                                  ...
                                  <hr>
                                  <h6>Untuk program studi dengan jumlah kebutuhan lulusan rendah berlaku perhitungan sebagai berikut. </h6>
                                  <ol style="list-style-type: none;">
                                    <b><li>Nilai 4</li></b>
                                    Jika selalu ada mahasiswa 
                                    baru terdaftar pada TS-4 
                            ...
                            <tr>
                              ...
                              <th scope="row">C.3.4.b) Daya 
                                ...
                                Studi</th>
                              <td>
                                  <h6>Skor = ((2 x A) + B) / 3</h6>
                                  <h6>A. Peningkatan animo 
                                    calon mahasiswa.
                                    <br><br>
                                    Tabel 2.a LKPS
                                  </h6>
                          ...
                          <tr>
                            ...
                            <td>
                                <h6>Skor = (A + (2 x B)) / 3</h6>
                                <h6>A. Ketersediaan layanan 
                                  kemahasiswaan di 
                                  bidang: 
                                  <ol>
                                    <li>
                        ...
                        <table class="table">
                          ...
                          <tr>
                            ...
                            <td>
                                ...
                                <h6>Kelompok Sains Teknologi</h6>
                                  <ol style="list-style-type: none;">
                                    <b><li>Nilai 4</li></b>
                                    Jika 15 ≤ RMD ≤ 25 , 
                                    maka Skor = 4                     
                                ...
                                <hr>
                                <h6>Kelompok Sosial Humaniora</h6>
                                  <ol style="list-style-type: none;">
                                    <b><li>Nilai 4</li></b>
                                    Jika 25 ≤ RMD ≤ 35 , 
                                    maka Skor = 4                  
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td> 
                                  ...
                                  <hr>
                                  <h6>B. Kesesuaian capaian 
                                    pembelajaran dengan 
                                    profil lulusan dan 
                                    jenjang KKNI/SKKNI.</h6>
                                    <ol style="list-style-type: none;">
                                      <b><li>Nilai 4</li></b>
                                      Capaian pembelajaran 
                                      diturunkan dari profil 
  ...
  <script>
    function toast(a) {
      iziToast.warning({
          ...
          position: 'bottomLeft',
          title: 'Warning',
          message: 'Skor No ' + a + ' Belum di Isi',
        });
    }
    function toast2(a) {
      iziToast.warning({
    ...
    $('#next2_btn').click(function() {
      ...
      if ($('#n2').val() == "") {
        ...
        iziToast.warning({
          ...
          position: 'bottomLeft',
          title: 'Warning',
          message: 'Skor No 2 Belum di Isi',
        });
      ...
      if ($('#n3').val() == "" || $('#n4').val() == "" || $('#n5').val() == "") {
        ...
        if ($('#n3').val() == "") {
          iziToast.warning({
            ...
            position: 'bottomLeft',
            title: 'Warning',
            message: 'Skor No 3 Belum di Isi',
          });
        }else if ($('#n4').val() == "") {
          iziToast.warning({
            messageColor: 'black',
            position: 'bottomLeft',
            title: 'Warning',
            message: 'Skor No 4 Belum di Isi',
          });
        }else if ($('#n5').val() == "") {
          iziToast.warning({
            messageColor: 'black',
            position: 'bottomLeft',
            title: 'Warning',
            message: 'Skor No 5 Belum di Isi',
          });
        }
      ...
      if ($('#n6').val() == "" || $('#n7').val() == "" || $('#n8').val() == "" || $('#n9').val() == "" || $('#n10').val() == "" || $('#n11').val() == "" || $('#n12').val() == "" || $('#n13').val() == "") {
        ...
        if ($('#n6').val() == "") {
          iziToast.warning({
            ...
            position: 'bottomLeft',
            title: 'Warning',
            message: 'Skor No 6 Belum di Isi',
          });
        }else if ($('#n7').val() == "") {
          iziToast.warning({
            messageColor: 'black',
            position: 'bottomLeft',
            title: 'Warning',
            message: 'Skor No 7 Belum di Isi',
          });
        }else if ($('#n8').val() == "") {
          iziToast.warning({
            messageColor: 'black',
            position: 'bottomLeft',
            title: 'Warning',
            message: 'Skor No 8 Belum di Isi',
          });
        }else if ($('#n9').val() == "") {
          iziToast.warning({
            messageColor: 'black',
            position: 'bottomLeft',
            title: 'Warning',
            message: 'Skor No 9 Belum di Isi',
          });
        }else if ($('#n10').val() == "") {
          iziToast.warning({
            messageColor: 'black',
            position: 'bottomLeft',
            title: 'Warning',
            message: 'Skor No 10 Belum di Isi',
          });;
        }else if ($('#n11').val() == "") {
          iziToast.warning({
            messageColor: 'black',
            position: 'bottomLeft',
            title: 'Warning',
            message: 'Skor No 11 Belum di Isi',
          });
        }else if ($('#n12').val() == "") {
          iziToast.warning({
            messageColor: 'black',
            position: 'bottomLeft',
            title: 'Warning',
            message: 'Skor No 12 Belum di Isi',
          });
        }else if ($('#n13').val() == "") {
          iziToast.warning({
            messageColor: 'black',
            position: 'bottomLeft',
            title: 'Warning',
            message: 'Skor No 13 Belum di Isi',
          });
        }
