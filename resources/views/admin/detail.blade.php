    ...
    <div class="card-body" style="font-size: 16pt">
      <table class="table table-borderless table-striped">
        <thead>
          <tr>
            <th scope="col">
              <h5 class="card-title mb-4">Nama Program Studi</h5>
            </th>
            <th scope="col">
              <h5 class="card-title mb-4">{{ $pengajuan['nama_program_studi'] }}</h5>
            </th>
          </tr>
        </thead>
        <tbody>
  ...
  <div class="col-sm-4">
    <div class="card">
      <div class="card-body">
        ...
        @if (count($file_ded) == 0)
        <center>
          <p class="card-text mt-3" style="color:red;">File DED Kosong</p>
        </center>
        @else
        <ul>
  ...
  <div class="col-sm-4">
    <div class="card">
      <div class="card-body">
        ...
        <center>
          <p class="card-text mt-3" style="color:red;">File DKPS Kosong</p>
        </center>
        @else
  ...
  <div class="col-sm-4">
    <div class="card">
      <div class="card-body">
        ...
        @if (count($lampiran) == 0)
        <center>
          <p class="card-text mt-3" style="color:red;">File Lampiran Kosong</p>
        </center>
        @else
        <ul>
...
<div class="row text-center mt-5 mb-4">
  ...
  <div class="col-md-6">
    <a href="/tolak/{{ $pengajuan['id'] }}"><button type="button" class="btn btn-outline-danger col-6">Tolak Pengajuan</button></a>
  </div>

  <div class="col-md-6">
    <a href="/terima/{{ $pengajuan['id'] }}"><button type="button" class="btn btn-outline-success col-6">Terima Pengajuan</button></a>
  </div>
